                ...
                <button
                  ...
                  className={`${
                    billingInterval === 'month'
                      ? 'relative w-1/2 bg-zinc-200 border-zinc-800 shadow-sm text-black'
            ...
            {products.map((product) => {
              ...
              return (
                <div
                  key={product.id}
                  className={cn(
                    'flex flex-col rounded-lg shadow-sm divide-y divide-zinc-600 bg-zinc-200',
                    {
                ...
                >
                  <div className="p-6">
                    ...
                    <Button
                      ...
                      className="block w-full py-2 mt-8 text-sm font-semibold text-center text-black rounded-md hover:bg-zinc-200"
                    >
